...
const loadCategoryData = async (categoryId) => {
  ...
  if(categoryItems.length === 0){
    ...
    videoContainer.classList.remove('grid', 'grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-4', 'gap-6')
    videoContainer.classList.add('grid', 'justify-center', 'items-center')
    ...
    categoryItems.forEach((video) => {
        ...
        div.innerHTML = `
        <figure><img class= "w-full h-[200px] rounded-lg" src="${video.thumbnail}" alt="image" /></figure>
        <div class="flex gap-4 my-5">
            ...
            <div class= "space-y-2">
                ...
                <small class= "inline">${video?.authors[0]?.profile_name},${video?.authors[0]?.verified ? `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
